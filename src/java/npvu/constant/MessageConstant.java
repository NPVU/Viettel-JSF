...
public class MessageConstant {
    ...
    public static final String MESSAGE_ERROR_SPECIAL_CHAR       = " có chứa ký tự không hợp lệ !";
    public static final String MESSAGE_ERROR_STR_LENGTH         = " có độ dài không hợp lệ !";
    public static final String MESSAGE_ERROR_EXISTS             = " đã tồn tại !";
}
